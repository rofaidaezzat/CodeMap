  ...
  return (
    <div className="lg:px-40 py-20 lg:pt-28">
      <div className="flex flex-col gap-3 pb-6">
        <h3 className="text-2xl font-serif">Frontend Development Tasks</h3>
        <p>Start your journey to become a frontend developer</p>
      </div>
      <div className="border-b-2 border-gray-400 mb-6">
        <ul className="flex gap-5 ">
          ...
          <li className="cursor-pointer" onClick={() => setSelectedTrack("js")}>
            Java Script
          </li>
        </ul>
      </div>
      ...
      {selectedTrack === "css" && (
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-2xl font-serif pb-2">Tasks lessons for css</h3>
            <div className="flex justify-between items-center bg-gray-400 p-2 rounded-md">
              <div className="flex gap-3 items-center">
                <BookOpenCheck
                  color="#000000"
