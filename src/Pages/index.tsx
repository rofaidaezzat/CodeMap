...
const HomePage = () => {
    ...
    <div className="bg-[#CFD8FF] rounded-b-xl ">
        ...
        >
            ...
            <Image imageurl="src/assets/Home/Group8.png" alt="error" className="w-10" />
            </div>
        ...
        <div className=" flex justify-between px-2 pb-2">
            ...
            <Image imageurl="src/assets/Home/Group12.png" alt="error" className="w-10" />
        </div>
    </div>
    {/* chatboot section */}
    ...
    <div className="w-16 h-16 md:w-24 md:h-24">
        <Image imageurl="src/assets/Home/chat.png" alt="Chatbot" className="w-full h-full image-container" />
    </div>
    ...
    <div className="my-10 p-5 flex flex-col md:flex-row md:h-[500px] h-[400px] lg:flex-row bg-[#CFD8FF] lg:justify-around gap-5  ">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start justify-center gap-10">
              {/* header */}
                <div className="flex">
                    ...
                    Premium <span>Learning</span><br/> Experience
                    </h3>
                </div>
        <div className="space-y-5 ">
            ...
            <div className="flex items-center justify-center space-x-2">
                ...
                <Image imageurl="src\assets\Home\hearts 1.png"  alt="error"   className="w-8 h-8" />
                </div>
                <div>
