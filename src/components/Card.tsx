...
const Card = ({ url, alt, title, describe }: Iprops) => {
    return (
    <>
        ...
        <img className="h-44 md:w-[400px] w-[300px] rounded-lg " src={url} alt={alt} />
        <div className="flex justify-between pt-5">
            <p className="text-[#a69d9d] md:w-auto   font-bold">{describe}</p>
            <div className="flex">
        ...
        <div className="flex lg:w-auto md:w-[400px]  w-auto gap-3 pb-8 ">
            ...
            <p className="text-[#a69d9d] md:text-sm text-auto lg:text-auto">22hr30min</p>
            </div>
            <div className="flex gap-1">
            <Video className="w-4" />
            <p className="text-[#a69d9d]  md:text-sm text-auto lg:text-auto">34 Courses</p>
            </div>
            <div className="flex gap-1">
            <Download  className="w-4"/>
            <p className=" text-[#a69d9d]  md:text-sm text-auto lg:text-auto">250 Sales</p>
            </div>
        </div>
        </div>
